...
__attribute__((always_inline, artificial)) inline uint8_t _uint8_min(uint8_t a, uint8_t b)
{
    return a < b ? a : b;
}

__attribute__((always_inline, artificial)) inline uint16_t _uint16_max(uint16_t a, uint16_t b)
{
    return a > b ? a : b;
}

__attribute__((always_inline, artificial)) inline uint16_t _uint16_min(uint16_t a, uint16_t b)
{
    return a < b ? a : b;
}

__attribute__((always_inline, artificial)) inline uint32_t _uint32_max(uint32_t a, uint32_t b)
{
    return a > b ? a : b;
}

__attribute__((always_inline, artificial)) inline uint32_t _uint32_min(uint32_t a, uint32_t b)
{
    return a < b ? a : b;
}
